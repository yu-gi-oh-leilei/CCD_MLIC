...
def main():
    ...
    # prepare data
    model, train_loader, val_loader, train_loader_cfer, train_sampler = main_prepare(args)
...
def main_prepare(args):
    ...
    train_loader_cfer = torch.utils.data.DataLoader(
        train_dataset, batch_size=args.batch_size // dist.get_world_size() // 8, shuffle=False,
        num_workers=args.workers, pin_memory=True, sampler=train_sampler, drop_last=True)    
    ...
    return model, train_loader, val_loader, train_loader_cfer, train_sampler
