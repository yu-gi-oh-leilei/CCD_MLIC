...
def parser_args():
    available_models = ['Q2L-R101-448', 'Q2L-R101-576', 'Q2L-TResL-448', 'Q2L-TResL_22k-448', 'Q2L-SwinL-384', 'Q2L-CvT_w24-384','CCD-R101-448']
    parser = argparse.ArgumentParser(description='Query2Label MSCOCO Training')
    parser.add_argument('--dataname', help='dataname', default='coco14', choices=['coco14', 'voc2007'])
    parser.add_argument('--dataset_dir', help='dir of dataset', default='/media/data2/MLICdataset/COCO2014/')
    ...
    parser.add_argument('--loss', default='focal', type=str, 
                        help='(mlsm, bce, focal, asl,halfasl, lsloss)')
    ...
    # ccd
    parser.add_argument('--use_tde', default=True, type=bool)
    parser.add_argument('--feat_fuse', default='selector', type=str,
                        help='none, mlp, selector, concat')
    ...
    parser.add_argument('--feat_dim', default=2048, type=int, 
                        help="Size of the feature maps (dimension of the feature maps)")
    ...
    parser.add_argument('-sybn', '--SyncBatchNorm', default=False, action='store_true', 
