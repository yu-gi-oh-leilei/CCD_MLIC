...
def get_model_path(modelname):
    ...
    pretrained_dir = '/media/data/maleilei/MLIC/query2labels/lib/models/pretrained'
    PTDICT = {
    ...
    def __init__(self, name: str,
        ...
        if name in ['resnet18', 'resnet50', 'resnet34', 'resnet101']:
            ...
            if pretrained:
                ...
                #     print(k)
                # body.layer4.2.conv1.1.running_var  org
                # backbone.body.body.layer4.2.conv3.1.running_mean  
                # print('checkpoint')
